    ...
    infor_context_module=dict(
        ...
        textual_embedding=dict(
            ...
            sentence_embedding_bert=dict(
                ...
                auto_model_path='/path/to/bert-base-cased/',
                embedding_dim=768,
                freeze_params=True,
                character_wise=True,
                use_cls=True,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="path/to/ComFinTab_eng_train.json",
        img_prefix="path/to/ComFinTab/eng/Images/train_img",
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file="path/to/ComFinTab_eng_test.json",
        img_prefix="path/to/ComFinTab/eng/Images/test_img",
...
evaluation = dict(
    ...
    metric_options=dict(
        ...
        save_name='ComFinTab_eng_test_pred.json'),  # where to save the inference results
    priority='HIGH')
