...
lexicon_root = "../../evaluation/lexicons/icdar2015/"
strong_lexicon_path = lexicon_root + "strong_lexicon/"
weak_lexicon = []
general_lexicon = []
if lexicon_type == "WEAK":
    weak_lexicon_file = codecs.open(lexicon_root + "ch4_test_vocabulary.txt", encoding="utf-8")
...
work_dir = "../eval_result/ICDAR2015/"
out_dir = work_dir + lexicon_type + "/"
pack_dir = work_dir + '/ICDAR2015_' + lexicon_type + '.zip'
