...
# Filename       :    mask_rcnn_r50_conv6_e2e_finetune_ic13.py
...
checkpoint_config = dict(interval=10, filename_tmpl='checkpoint/mask_rcnn_r50_conv6_e2e_finetune_epoch_{}.pth')
work_dir = '/path/to/workspace/log/'
load_from = '/path/to/mask_rcnn_r50_conv6_e2e_pretrain.pth'
evaluation = dict(
    interval=10,
)
