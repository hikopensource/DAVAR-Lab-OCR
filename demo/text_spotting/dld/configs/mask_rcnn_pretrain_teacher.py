...
# Filename       :    mask_rcnn_pretrain.py
# Abstract       :    Model settings for mask-rcnn-based text spotter
...
train_pipeline = [
    ...
    dict(type='DavarResize', img_scale=[(320, 1600), (384, 1600), (448, 1600), (512, 1600), (576, 1600), 
                                        (640, 1600), (704, 1600), (768, 1600), (832, 1600), (896, 1600)], 
...
checkpoint_config = dict(type='DavarCheckpointHook', interval=10, filename_tmpl='checkpoint/mask_rcnn_res50_multi_scale_epoch_{}.pth')
...
load_from = '/path/to/mask_rcnn_r50_conv6_e2e_pretrain-4d43358a.pth'
resume_from = None
workflow = [('train', 1)]
