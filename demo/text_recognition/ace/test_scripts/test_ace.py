...
# model name setting
out_name = 'davar_test_ace_new'

# model parameter dictionary
tmp_dict = dict()

# experiment Name
tmp_dict['Name'] = 'ace_new'

# ===================== model .pth file path ========================
tmp_dict['ModelPath'] = '/data1/workdir/davar_opensource/ace_new//Best_checkpoint.pth'
out_name += '/' + tmp_dict['ModelPath'].split('/')[-2].split('.')[0]

# ===================== model config file path ========================
tmp_dict['ConfigPath'] = '/data1/open-source/demo/text_recognition/ace/configs/ace_res32.py'
