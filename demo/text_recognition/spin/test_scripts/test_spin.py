...
# Abstract       :    SPIN Transformation Model evaluation config
...
# ===================== model .pth file path ========================
tmp_dict['ModelPath'] = '/data1/workdir/davar_opensource/spin/Spin_pretrained-251eaf77.pth'
out_name += '/' + tmp_dict['ModelPath'].split('/')[-2].split('.')[0]

# ===================== model config file path =======================
tmp_dict['ConfigPath'] = '/data1/open-source/demo/text_recognition/spin/configs/spin_res32_attn.py'
